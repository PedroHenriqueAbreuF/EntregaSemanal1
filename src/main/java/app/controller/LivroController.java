...
public class LivroController {
	...
	public ResponseEntity<String> save(@RequestBody Livro livro) {
		...
		try {
			...
			return new ResponseEntity<String>(mensagem, HttpStatus.CREATED);
				...
				return new ResponseEntity<String>("Erro 1: "+e.getMessage(), HttpStatus.BAD_REQUEST);  
			}
	}
	...
	public ResponseEntity<String> update(@RequestBody Livro livro, @PathVariable int id) {
		...
		try {
			...
			return new ResponseEntity<String>("Erro 2: "+e.getMessage(), HttpStatus.BAD_REQUEST);
